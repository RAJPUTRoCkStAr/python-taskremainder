...
def about():
    ...
    def open_github():
        webbrowser.open_new_tab("https://github.com/RAJPUTRoCkStAr")
...
Aboutbtn.grid(row=10, column=0,rowspan=18 ,columnspan=2, padx=5, pady=5, sticky="ew")
